...
const navigation = [
  ...
  {
    name: "GitHub (iabdulkarim472)",
    href: "https://github.com/iabdulkarim472",
    icon: (props: Props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: "GitHub (aliveevie)",
    href: "https://github.com/aliveevie",
    icon: (props: Props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
      ...
      <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-base text-black">
            &copy; {new Date().getFullYear()} Festify - Send Festival Greetings as NFTs
          </p>
        </div>
      </div>
    </footer>
